...
**Download:** [latest release](https://github.com/liquid-releasing/funscriptforge-releases/releases/latest) • **Docs:** [liquid-releasing.github.io/funscriptforge](https://liquid-releasing.github.io/funscriptforge/) • **Community:** [Discord](https://discord.gg/Eytatcx8Jm)
...
| [docs/architecture/TONE_TAB_SPEC.md](docs/architecture/TONE_TAB_SPEC.md) | Tone tab design spec — the 6 tones, card UI, beat envelopes, caption emotion, data model |
| [docs/architecture/AUTO_METADATA_SPEC.md](docs/architecture/AUTO_METADATA_SPEC.md) | Auto-derived metadata spec — pace/intensity/arc/mood/tags/tone suggestion |
| [docs/architecture/HAPTIC_COMPOSITION_SPEC.md](docs/architecture/HAPTIC_COMPOSITION_SPEC.md) | Three-layer haptic composition — base funscript + beats + caption emotion |
