...
export function exportWrite(funscriptPath, { mode = 'forge', out = null, blendSeams = false, finalSmooth = false, stem = null, media = null, stimAudio = false } = {}) {
  return call(
    'export_write',
    { funscriptPath, mode, out, blendSeams, finalSmooth, stem, media, stimAudio },
    () => Promise.resolve(null),
  );
}
